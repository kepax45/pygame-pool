...
while running:
    ...
    if start_pos and end_pos:
        ...
        tacke = reduce(check_collision(k, n, w1.r), x1, y1, x2, y2)
        nX, nY = find_nearest(x1, y1, x2, y2, tacke)
        pygame.draw.line(window, (0, 255, 0), start_pos, (nX, nY))
        pygame.draw.rect(window, (0, 255, 0), (nX, nY, 5, 5))
    pygame.display.flip()
    window.fill((0, 0, 0))
pygame.quit()
